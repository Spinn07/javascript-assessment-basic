...
function coderTest(obj){
	for (var prop in obj){
		if(prop === 'Jeremy'){
			...
			obj['lovesCode'] = 0;
		} else if(prop !== 'Jeremy' || prop !== 'Brack') {
			 obj['lovesCode'] = 5;
		}
	}
}
...
function callerBack(str) {
	return function holla(str){
		return str + "back";

	};
}
var giveIt = callerBack();
giveIt("give it ");
